...
- build & deploy: `npm run build && aws s3 cp --recursive ~/learn/prasanna_web/public/ s3://prashub.com/prasanna/public/ && aws cloudfront create-invalidation --distribution-id E3L63XU4ZVC19X --paths "/*"`
